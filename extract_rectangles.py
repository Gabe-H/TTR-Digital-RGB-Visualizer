...
def main():
    if len(sys.argv) not in (2, 3):
        print("Usage: python extract_rectangles.py drawing.svg [output.csv]")
        sys.exit(1)
    ...
    # )
    output_path = svg_path.with_name("rectangle_centers_rotations.csv")

    rows = extract_rectangles(svg_path)
